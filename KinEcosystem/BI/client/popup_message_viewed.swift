...
struct PopupMessageViewed: KBIEvent {
    let client: Client
    let common: Common
    let eventName: String
    let eventType: String
    let messageType: KBITypes.MessageType
    let user: User
...
extension PopupMessageViewed {
    init(messageType: KBITypes.MessageType) throws {
        ...
        eventName = "popup_message_viewed"
        eventType = "analytics"
